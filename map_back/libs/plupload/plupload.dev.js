...
(function(global, factory) {
    ...
    (function(exports, o, undef) {
        ...
        var plupload = {
             ...
             * @returns {Object} Same as target, the extended object.
             */
             ...
             * @method guid
             * @static
             * @returns {String} Virtually unique id.
             */
            guid: u.Basic.guid,
            ...
            */
             ...
             * @returns {object} Absolute position of the specified element object with x, y fields.
             */
            getPos: u.Dom.getPos,
             ...
             * @returns {Object} Object with a w and h property.
             */
             ...
             * @returns {Array} Array object containing all items.
             */
             ...
             * @param {Array} array
             * @returns {Int} Index of the element, or -1 if not found
             */
            ...
            */
             ...
             * @returns {Object} Extended language pack object.
             */
             ...
             * @returns {String} Translated string or the input string if it wasn't found.
             */
             ...
             * @returns {String} String with replaced tokens
             */
             ...
             * @returns {String} String with url + serialized query string items.
             */
             ...
             * @returns {String} Type of compatible runtime
             */
        ...
        */
        plupload.Uploader = function(options) {
            ...
            plupload.extend(this, {
                 ...
                 * @returns {Mixed} Value for the option or the whole set
                 */
                 ...
                 * @returns {plupload.File} File object or undefined if it wasn't found;
                 */
                getFile: function(id) {
                    var i;
                 ...
                 * @returns {Array} Array of files that was removed.
                 */
        ...
        plupload.File = (function() {
            ...
            function PluploadFile(file) {
                ...
                plupload.extend(this, {
                     ...
                     *
                     * @method getNative
                     * @returns {window.File} or null, if plupload.File is of different origin
                     */
                    getNative: function() {
