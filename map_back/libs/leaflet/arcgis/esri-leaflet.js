...
(function (factory) {
    ...
    EsriLeaflet.Tasks.Task = L.Class.extend({
        ...
        initialize: function (endpoint, options) {
            ...
            if (L.dci.app.pool.get('map')) { this.params.outSr = L.dci.app.pool.get('map').getMap().options.crsNum; }
    ...
    EsriLeaflet.Tasks.Query = EsriLeaflet.Tasks.Task.extend({
        ...
        _setGeometry: function (geometry) {
            if (L.dci.app.pool.get('map')) {
                this.params.inSr = L.dci.app.pool.get("map").getMap().options.crsNum || 4326;
            }
            //this.params.inSr = 4326;
